...
HD_PWD='/home/dragos/lane_project/edit_lane_linear_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lane_linear_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lane_linear_ip_v1_0.tcl
