...
HD_PWD='/home/dragos/line_follower/line_follower.runs/design_1_lane_linear_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_lane_linear_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_lane_linear_ip_0_1.tcl
